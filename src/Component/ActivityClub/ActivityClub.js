    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-12 '>
            <div className='col-span-12 lg:col-span-9  bg-blue-300 pb-20 lg:pl-8 space-y-7'>
                <h1 className='text-5xl mt-16 pl-2 lg:pl-10'> <FontAwesomeIcon icon={faDumbbell}></FontAwesomeIcon> Ways To Get Active</h1>
            ...
            <div className='col-span-12 lg:col-span-3 bg-pink-200'>
